...
echo ""
echo "Next steps:"
echo "1. Start your LLM backend:"
echo "   • Ollama: ollama serve && ollama pull codellama:latest"
echo "   • vLLM: python -m vllm.entrypoints.openai.api_server --model your-model"
echo ""
